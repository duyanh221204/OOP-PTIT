...
public class Main
{
    public static void main(String[] args)
    {
        ...
        ArrayList<DS> a = new ArrayList<>();
        for (int i = 1; i <= n; ++i) a.add(new DS(i, sc.nextLine(), sc.nextLine(), Double.parseDouble(sc.nextLine()), Double.parseDouble(sc.nextLine())));
        Collections.sort(a);
        for (DS i : a) System.out.println (i);
    }
}
